<div id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-slate-900 h-full flex flex-col transform transition-all duration-300 ease-in-out lg:static translate-x-0 [.sidebar-closed_&]:-translate-x-full lg:[.sidebar-closed_&]:w-0 lg:[.sidebar-closed_&]:translate-x-0 overflow-hidden">
    ...
    <nav class="flex-1 overflow-y-auto py-4">
        <ul class="space-y-1 px-2">
            <li>
                <a href="{{ route('dashboard') }}" class="group flex items-center px-4 py-3.5 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors {{ request()->routeIs('dashboard') ? 'bg-slate-800 text-white' : '' }}">
                    <svg class="w-6 h-6 mr-3 shrink-0" fill="none" class="current-fill" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li>
                <a href="{{ route('warehouses.index') }}" class="group flex items-center px-4 py-3.5 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors {{ request()->routeIs('warehouses.*') ? 'bg-slate-800 text-white' : '' }}">
                    <svg class="w-6 h-6 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
                    <span class="text-base font-medium">Warehouses</span>
                </a>
            </li>
            <li>
                <a href="{{ route('categories.index') }}" class="group flex items-center px-4 py-3.5 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors {{ request()->routeIs('categories.*') ? 'bg-slate-800 text-white' : '' }}">
                    <svg class="w-6 h-6 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li>
                <a href="{{ route('customers.index') }}" class="group flex items-center px-4 py-3.5 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors {{ request()->routeIs('customers.*') ? 'bg-slate-800 text-white' : '' }}">
                    <svg class="w-6 h-6 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li>
                <a href="{{ route('reports.daily') }}" class="group flex items-center px-4 py-3.5 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors {{ request()->routeIs('reports.daily') ? 'bg-slate-800 text-white' : '' }}">
                    <svg class="w-6 h-6 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <span class="text-base font-medium">Daily Sale Report</span>
                </a>
            </li>
            <li>
                <a href="{{ route('reports.items') }}" class="group flex items-center px-4 py-3.5 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors {{ request()->routeIs('reports.items') ? 'bg-slate-800 text-white' : '' }}">
                    <svg class="w-6 h-6 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                    </svg>
                    <span class="text-base font-medium">Sale Items Report</span>
                </a>
            </li>
            <li>
                <a href="{{ route('reports.receipts') }}" class="group flex items-center px-4 py-3.5 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors {{ request()->routeIs('reports.receipts') ? 'bg-slate-800 text-white' : '' }}">
                    <svg class="w-6 h-6 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <span class="text-base font-medium">Receipts</span>
                </a>
            </li>
            @endcan
