        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $product->name) }}" class="w-full px-3 py-2 border @error('name') border-red-500 @else border-slate-300 @enderror rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" required>
                    @error('name')
                        <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div>
                ...
                <input type="text" name="sku" value="{{ old('sku', $product->sku) }}" class="w-full px-3 py-2 border @error('sku') border-red-500 @else border-slate-300 @enderror rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                @error('sku')
                    <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" name="current_selling_price" value="{{ old('current_selling_price', $product->current_selling_price) }}" class="w-full px-3 py-2 border @error('current_selling_price') border-red-500 @else border-slate-300 @enderror rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" step="1" required>
                @error('current_selling_price')
                    <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" name="price_per_pyi" value="{{ old('price_per_pyi', $product->price_per_pyi) }}" class="w-full px-3 py-2 border @error('price_per_pyi') border-red-500 @else border-slate-300 @enderror rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" step="1">
                @error('price_per_pyi')
                    <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" name="pyi_per_bag" value="{{ old('pyi_per_bag', (int)$product->pyi_per_bag) }}" class="w-full px-3 py-2 border @error('pyi_per_bag') border-red-500 @else border-slate-300 @enderror rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" placeholder="e.g. 24 or 6" step="1" min="1">
                @error('pyi_per_bag')
                    <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" rows="3" class="w-full px-3 py-2 border @error('description') border-red-500 @else border-slate-300 @enderror rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('description', $product->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                @enderror
            </div>
